...
/**
 * Boots an embedded Keycloak instance for IPM demo purposes.
 * <p>
 ...
 * configuration points used by the various IPM examples.
 */
@Configuration
public class EmbeddedKeycloakConfig {
     ...
     * the server via Keycloak's Quarkus distribution for local IPM demos.
     */
    @PostConstruct
    public void start() {
